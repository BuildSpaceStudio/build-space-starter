---
name: buildspace-sdk
description: Implements features using the BuildSpace SDK (@buildspacestudio/sdk) for authentication, event tracking, file storage, and email notifications. Use when adding or modifying auth flows, tracking user events, handling file uploads, or sending transactional emails in this Next.js project.
---
