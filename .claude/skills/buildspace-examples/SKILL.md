...
description: Preferred patterns and recipes for building features with the BuildSpace SDK in this Next.js project. Use when adding authentication UI, route protection, server actions, event tracking, file storage, email notifications, or protected API routes.
---

# BuildSpace Patterns & Recipes

Preferred patterns for building on the BuildSpace starter. Each recipe is self-contained with complete file contents. For SDK method signatures and options, see the [SDK skill](../buildspace-sdk/SKILL.md) and [API reference](../buildspace-sdk/api-reference.md).

## Conventions

- This project uses Next.js 16 App Router, TypeScript, Tailwind CSS
